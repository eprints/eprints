...
### 
### $Log$
### Revision 1.1  2002/02/13 15:38:46  moj199
### Mega-bundle! :-)
###
### Revision 1.1  2002/02/08 18:19:32  moj199
### - Added perl_mods dirs to release folder
### - Added dirs to files.conf and dirs.conf
### - Added extra tweak to files.conf - adding an extra field (whatever the contents) tells the package maker to recurse into the dir.
### - Bug-fix in installer - now correctly calls post_install.
### - Added sanity warning for SIGNATURES.
###
