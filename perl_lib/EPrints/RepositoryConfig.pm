...
B<EPrints::RepositoryConfig> - A single eprint repository configuration

=head1 DESCRIPTION

This class is a single eprint repository configuration, and is used to cache 
the config. to save reloading between web requests.
...
#	if( defined $ARCHIVE_CACHE{$self->{id}} )
#	{
#		my $self = $ARCHIVE_CACHE{$self->{id}};
