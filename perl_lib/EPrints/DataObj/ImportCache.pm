...
package EPrints::DataObj::ImportCache;
...
sub get_system_field_info
{
	...
	return
	( 
		{ name=>"import_cacheid", type=>"counter", sql_counter=>"import_cacheid", },

		{ name=>"importid", type=>"itemref", required=>1, datasetid=>"import", },
...
sub create_from_data
{
	...
	$epdata->{importid} = $parent->id if defined $parent;
