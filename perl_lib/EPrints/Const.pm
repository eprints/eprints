...
use constant {
	...
	EP_TRIGGER_THUMBNAIL_TYPES => 17,
 	EP_TRIGGER_REQUEST_PROCESSING => 18,
 	EP_TRIGGER_REQUEST_CONTROLLER => 19,
 	EP_TRIGGER_REQUEST_AUTH_CREDENTIALS => 20,
};
...
@trigger = qw(
	...
	EP_TRIGGER_THUMBNAIL_TYPES
 	...
 	EP_TRIGGER_REQUEST_PROCESSING
 	EP_TRIGGER_REQUEST_CONTROLLER
 	EP_TRIGGER_REQUEST_AUTH_CREDENTIALS
